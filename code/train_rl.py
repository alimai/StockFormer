...
if __name__ == '__main__':
    ...
    if train_mode:
        ...
        policy_kwargs = {"optimizer_kwargs": {"weight_decay": 1e-4},# 作用：惩罚大的权重值，促使网络权重保持较小，提高泛化能力
        ...
        if load_pretrain:
            ...
            model_sac = agent.get_model("maesac",model_kwargs = config.MAESAC_PARAMS,tensorboard_log=tensorboard_log_dir, policy_kwargs=policy_kwargs)
